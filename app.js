document.addEventListener('DOMContentLoaded', () => {
    ...
    async function uploadAndAnalyze(file) {
        ...
        // Dynamically determine API URL based on protocol/port to allow decoupled frontend hosting
        const isLocalhost = window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1';
        const apiBase = (window.location.protocol === 'file:' || (isLocalhost && window.location.port !== '8000'))
            ? 'http://127.0.0.1:8000'
            : '';
